...
module.bundle.HMR_BUNDLE_ID = "ca997f44ede77152";
"use strict";
...
},{}],"coQBE":[function(require,module,exports) {
...
function loadMeal() {
    ...
    if (selectedItem.recipe.totalTime === 0) time.innerHTML = `<p class="fst-italic">not available</p>`;
